...
<div class="undermenuarea">
	...
	<div class="grid">
		<div class="row">
			<div class="c8">
				<h1 class="titlehead"><?php the_title(); ?></h1>
			</div>
			<div class="c4">
...
<?php if ( have_posts() ) : the_post(); ?>
	<div class="c9 space-top">
		...
		<meta property="og:image" content="<?php if ( has_post_thumbnail() ) {the_post_thumbnail_url('large');}else{echo get_template_directory_uri().'/default/default-image-thumb.jpg'; }?>" />
	...
	<div class="c3 space-top">
		...
		<img src="<?php the_post_thumbnail_url('thumbnail') ?>" onerror="this.src='<?php echo get_template_directory_uri(); ?>/default/default-image.jpg'" class="imgOpa teamimage" alt="">
