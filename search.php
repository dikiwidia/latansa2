...
<div class="row space-top">
	<div class="c8 space-top">
		<h1 class="maintitle">
		<?php printf( __( '%s', 'shape' ), '<span>Hasil pencarian: "' . get_search_query() . '"</span>' ); ?>
		</h1>	
		<div class="c12">
			<!-- BEGIN TEAM STYLE 2
			================================================== -->
			...
			<div class="c6">
				<p>
					<img class="latansa-thumb" src="<?php if ( has_post_thumbnail() ) {the_post_thumbnail_url('thumbnail');}?>" onerror="this.src='<?php echo get_template_directory_uri(); ?>/default/default-image.jpg'"  style="border-bottom: 5px solid #eee;" alt="">
				</p>
			</div>
			<div class="c6">
			...
			<div class="c10" style="text-align:center;margin-top:50px;margin-bottom:130px;">
				...
				<p>
						Tidak ada hasil dari pencarian dengan kata kunci: "<?php echo get_search_query(); ?>".<br /> Anda bisa melakukan pencarian lainnya atau kembali ke halaman utama.
				</p>
				<br/>
				<div class="actionbutton">
					<a href="<?php echo site_url(); ?>"><i class=" icon-link"></i> Kunjungi Halaman Utama</a>
				</div>
			</div>
			<div class="c1">
			</div>
